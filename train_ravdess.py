...
def run_alpha_sweep_full(img_tr, aud_tr, lbl_tr, img_te, aud_te, lbl_te, cl_f1, cl_acc, cfg,
                          checkpoint_path="./checkpoints/ravdess_alpha_sweep_200.pkl"):
    print("\n" + "═" * 60)
...
def main():
    ...
    parser.add_argument("--images-dir", default="./images_ravdess_200",
                         help="Where to save output figures")
    parser.add_argument("--checkpoint-path", default="./checkpoints/ravdess_client_sweep_200.pkl",
    ...
    sweep_results_full = run_alpha_sweep_full(
        img_tr, aud_tr, lbl_tr, img_te, aud_te, lbl_te, cl_f1, cl_acc, cfg, checkpoint_path="./checkpoints/ravdess_alpha_sweep_200.pkl")
